...
WEEKLY_DEEP_QUESTIONS = [
    "Что в этой неделе особенно отозвалось в тебе эмоционально?",
    "Какая тема или ситуация чаще всего возвращалась в твоей неделе?",
    "Что было для тебя ресурсом, а что — источником напряжения?",
    "Какая ценность была важна в течение этой недели, а какая оказалась нарушена?",
    "Что бы ты хотел(а) оставить в себе после этой недели?",
    "Какое одно изменение могло бы сделать следующую неделю легче?",
]
